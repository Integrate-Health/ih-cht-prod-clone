...
module.exports = [
  {
    ...
    appliesIf: function (c, r) {
      return !isAlive(c.contact, c.reports);
    },
    dhis: {
      dataSet: `VMuFODsyWAO`,
...

  {
    ...
    appliesIf: function (c, r) {
      return (
        ...
        isFormBetween21and20(r, [`home_visit`, `death_report`])
      );
    },
    aggregate: true,
  },

  {
    ...
    appliesTo: `reports`,
    appliesIf: function (c, r) {
      return isAlive(c.contact, c.reports) && hasAllVisitActionsMonthly(r);
    },
    aggregate: true,
  },

  {
    ...
    appliesTo: `reports`,
    appliesIf: function (c, r) {
      return isAlive(c.contact, c.reports) && getChildPatologie(r, `paludisme`);
    },
    aggregate: true,
  },

  {
    ...
    appliesIf: function (c, r) {
      return (
        isAlive(c.contact, c.reports) && getChildPatologie(r, `toux_rhume`)
      );
    },
    aggregate: true,
  },

  {
    ...
    appliesTo: `reports`,
    appliesIf: function (c, r) {
      return isAlive(c.contact, c.reports) && getChildPatologie(r, `pneumonia`);
    },
    aggregate: true,
  },

  {
    ...
    appliesTo: `reports`,
    appliesIf: function (c, r) {
      return isAlive(c.contact, c.reports) && getChildPatologie(r, `diarrhea`);
    },
    aggregate: true,
  },

  {
    ...
    appliesIf: function (c, r) {
      return (
        isAlive(c.contact, c.reports) && getChildPatologie(r, `malnutrition`)
      );
    },
    aggregate: true,
  },
  ...
  //   appliesTo: `reports`,
  //   appliesIf: function (c, r) {
  //     return isAlive(c.contact, c.reports) && getChildPatologiePromptitude(r, `paludisme`, '24h');
  //   },
  //   aggregate:true
  // },
  // {
  ...
  //   appliesTo: `reports`,
  //   appliesIf: function (c, r) {
  //     return isAlive(c.contact, c.reports) && getChildPatologiePromptitude(r, `toux_rhume`, '24h');
  //   },
  //   aggregate:true
  // },
  // {
  ...
  //   appliesTo: `reports`,
  //   appliesIf: function (c, r) {
  //     return isAlive(c.contact, c.reports) && getChildPatologiePromptitude(r, `pneumonia`, '24h');
  //   },
  //   aggregate:true
  // },
  // {
  ...
  //   appliesTo: `reports`,
  //   appliesIf: function (c, r) {
  //     return isAlive(c.contact, c.reports) && getChildPatologiePromptitude(r, `diarrhea`, '24h');
  //   },
  //   aggregate:true
  // },
  // {
  ...
  //   appliesTo: `reports`,
  //   appliesIf: function (c, r) {
  //     return isAlive(c.contact, c.reports) && getChildPatologiePromptitude(r, `malnutrition`, '24h');
  //   },
  //   aggregate:true
  // },

  {
    ...
    appliesTo: `reports`,
    appliesIf: function (c, r) {
      return isAlive(c.contact, c.reports) && isFeverTdrGivenMonthly(r);
    },
    aggregate: true,
  },

  {
    ...
    appliesIf: function (c, r) {
      return (
        isAlive(c.contact, c.reports) && isFeverTdrGivenMonthly(r, `positive`)
      );
    },
    aggregate: true,
  },
  ...
  //   appliesTo: `reports`,
  //   appliesIf: function (c, r) {
  //     return isAlive(c.contact, c.reports) && isFeverTdrGivenMonthly(r, `negative`);
  //   },
  //   aggregate:true
  // },

  {
    ...
    appliesTo: `reports`,
    appliesIf: function (c, r) {
      return isAlive(c.contact, c.reports) && isActiveFamilyPlanning(c, r);
    },
    aggregate: true,
  },
  ...
  //   appliesTo: `reports`,
  //   appliesIf: function (c, r) {
  //     return isAlive(c.contact, c.reports) && isActiveOralCombinationPillFamilyPlanning(c, r);
  //   },
  //   aggregate:true
  // },
  // {
  ...
  //   appliesTo: `reports`,
  //   appliesIf: function (c, r) {
  //     return isAlive(c.contact, c.reports) && isActiveInjectibleFamilyPlanning(c, r);
  //   },
  //   aggregate:true
  // },

  {
    ...
    appliesIf: function (c, r) {
      return (
        isAlive(c.contact, c.reports) &&
        isBetween21and20(r.reported_date) &&
        (c.contact.type === `clinic` ||
          (c.contact.type === `person` && c.contact.role === `patient`))
      );
    },
    idType: (c, r) => {
      ...
      const householdVisitDates = new Set(
        c.reports.map((report) => toDateString(report.reported_date))
      );
  ...
  //   appliesTo: `reports`,
  //   appliesIf: function (c, r) {
  //     return isAlive(c.contact, c.reports) && isTotalPcimeCMonthly(r);
  //   },
  //   aggregate:true
  // },
  ...
  //   appliesTo: `reports`,
  //   appliesIf: function (c, r) {
  //     return isAlive(c.contact, c.reports) && isTotalPcimeCFollowupMonthly(r);
  //   },
  //   aggregate:true
  // },

  {
    ...
    appliesTo: `reports`,
    appliesIf: function (c, r) {
      return isAlive(c.contact, c.reports) && isPregnantMonthly(r);
    },
    aggregate: true,
  },
  ...
  //   appliesTo: `reports`,
  //   appliesIf: function (c, r) {
  //     return isAlive(c.contact, c.reports) && isPregnant(c.reports);
  //   },
  //   aggregate:true
  // },
...

  {
    ...
    appliesIf: function (c, r) {
      return (
        isAlive(c.contact, c.reports) &&
        isFormBetween21and20(r, [`postnatal_followup`])
      );
    },
    aggregate: true,
  },
  ...
  //       if (notNull(getMostRecentReport(c.report, [h]))) {
  //         return found++;
  //       }
  //     }
  //     return found > 0;
